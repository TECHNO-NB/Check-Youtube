...
const Uploadloader = () => {
  const {setModal}=useContext(showhidemodal)
  return (
    <div className='fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10 text-white'>
        <div className='px-6 w-[300px] h-60 bg-[#1F2937] border  text-2xl rounded-2xl md:w-[500px] md:h-60'>
         ...
         <div className='flex justify-between mt-4 gap-4'>
          <button className='w-[55vw] rounded-[5px] bg-none border h-10 cursor-pointer  md:w-[14vw]'  onClick={()=>setModal(true)}>Cancel</button>
